...
const AppUserNetworkerSocialProfile = Loadable(lazy(() => import('views/application/users/networker-social-profile')));
...
const AppECommNetworkerServiceDetails = Loadable(lazy(() => import('views/application/e-commerce/ServiceDetails')));
...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/user/networker-social-profile/:tab',
            element: <AppUserNetworkerSocialProfile />
        },
        {
        ...
        {
            path: '/e-commerce/networker-service-details/:id',
            element: <AppECommNetworkerServiceDetails />
        },
        {
