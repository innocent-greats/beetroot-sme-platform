...
const slice = createSlice({
    ...
    reducers: {
        ...
        // GET FRIEND REQUESTS
        getServicesRequestsSuccess(state, action) {
            state.servicesRequests = action.payload;
        },
        ...
        getServicesSuccess(state, action) {
            console.log('getServicesSuccess', action.payload)
...
export function getServicesRequests() {
    return async () => {
        try {
            const response = await axios.get('/api/services-request/list');
            dispatch(slice.actions.getServicesRequestsSuccess(response.data.servicesRequests));
        } catch (error) {
            dispatch(slice.actions.hasError(error));
        }
    };
